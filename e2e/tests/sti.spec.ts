...
test.describe("STI (Single Table Inheritance)", () => {
  ...
  test("physical product form shows weight field", async ({ page }) => {
    await page.goto("/admin/physical_product/new");
